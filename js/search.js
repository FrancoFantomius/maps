...
export function renderSearchResults(results) {
    ...
    results.forEach(item => {
        ...
        rDiv.className = 'p-3 border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-850 cursor-pointer transition-colors text-slate-700 dark:text-slate-350';
